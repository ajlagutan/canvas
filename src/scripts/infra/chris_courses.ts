...
export namespace chris_courses {
  type chris_vector = { x: number; y: number };
  type chris_particle = chris_vector & { velocity: chris_vector; mass: number };
  /**
  ...
  export function resolveCollision(
    particle: chris_particle,
    otherParticle: chris_particle
  ): void {
   ...
   */
  export function rotate(velocity: chris_vector, angle: number): chris_vector {
    return {
